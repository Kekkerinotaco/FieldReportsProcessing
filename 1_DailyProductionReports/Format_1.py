...
def main(folder_to_process, result_file):
    ...
    for date in dates_list:
        ...
        try:
            ...
            try:
                somBP_vstavka_sheet = svodka_book["SheetName1"]
            except KeyError:
                somBP_vstavka_sheet = svodka_book["SheetName1"]
            try:
            ...
            somBP_values = take_somBP_values(somBP_vstavka_sheet)
            put_somBP_values(result_worksheet, row_number, somBP_values)
...
def take_somBP_values(worksheet):
    ...
    cells_values = {}
    for cell, column in somBP_columns_dict.items():
...
def put_somBP_values(result_worksheet, row_number, values):
